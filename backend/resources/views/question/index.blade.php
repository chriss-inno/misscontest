                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 pull-right">
                        <div class="btn-group btn-group-justified">
                            <a class="createQuestion btn btn-primary" href="#">Create New</a>
                            <a class="btn btn-primary" href="{{url('questions/manage')}}">Manage</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                        ...
                        @foreach($questions as $question)
                            <tr >
                                ...
                                <td class="text-center"> <a href="#" class="btn btn-success btn-xs"><i class="fa fa-list"></i></a></td>
